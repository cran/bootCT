#' Summarizing the ARDL bootstrap and asymptotic procedures
#'
...
--------------------------------------------------------------------------
                 <------- I(0) ----- I(1) ----->
10% critical value       ",sprintf("%.2f",SUMMARY_PSS[[1]]$ftest.I0.p10),"     ",sprintf("%.2f",SUMMARY_PSS[[1]]$ftest.I1.p10),
  "\n5% critical value        ",sprintf("%.2f",SUMMARY_PSS[[1]]$ftest.I0.p05),"     ",sprintf("%.2f",SUMMARY_PSS[[1]]$ftest.I1.p05),
  "\n1% critical value        ",sprintf("%.2f",SUMMARY_PSS[[1]]$ftest.I0.p01),"     ",sprintf("%.2f",SUMMARY_PSS[[1]]$ftest.I1.p01),
  "\n\nF-statistic (C) = ",sprintf("%.2f",SUMMARY_PSS[[1]]$fstat)," F-statistic (UC) = ",sprintf("%.2f",SUMMARY_PSS[[2]]$fstat),
  "\n\n     Bootstrap critical values\n    ",
  paste0(paste(FOV[,1]*100,"%"),collapse="     "),
  "\nC  ",paste0(sprintf("%.2f",round(FOV[,2],2)),collapse="     "),
  "\nUC ",paste0(sprintf("%.2f",round(FOV[,3],2)),collapse="     "))
...
--------------------------------------------------------------------------
                  <------- I(0) ----- I(1) ----->
10% critical value       ",sprintf("%.2f",SUMMARY_PSS[[1]]$ttest.I0.p10),"    ",sprintf("%.2f",SUMMARY_PSS[[1]]$ttest.I1.p10),
    "\n5% critical value        ",sprintf("%.2f",SUMMARY_PSS[[1]]$ttest.I0.p05),"    ",sprintf("%.2f",SUMMARY_PSS[[1]]$ttest.I1.p05),
    "\n1% critical value        ",sprintf("%.2f",SUMMARY_PSS[[1]]$ttest.I0.p01),"    ",sprintf("%.2f",SUMMARY_PSS[[1]]$ttest.I1.p01),
    ...
    "\nC  ",paste0(sprintf("%.2f",round(TDEP[,2],2)),collapse="     "),
    "\nUC ",paste0(sprintf("%.2f",round(TDEP[,3],2)),collapse="     "))}else{
      cat(
        "\n\n\nObservations:",SUMMARY_PSS[[1]]$obs,
        "\nNumber of Lagged Regressors (not including LDV) (k): ",SUMMARY_PSS[[1]]$k,
        "\nCase: ",SUMMARY_PSS[[1]]$case,"
       \nPSS bound t-test not applicable for case ",SUMMARY_PSS[[1]]$case,
        ...
        paste0(paste(TDEP[,1]*100,"%"),collapse="      "),
        "\nC  ",paste0(sprintf("%.2f",round(TDEP[,2],2)),collapse="     "),
        "\nUC ",paste0(sprintf("%.2f",round(TDEP[,3],2)),collapse="     "))
    }
...
10% critical value       ",SUMMARY_SMG[1,4],"     ",SUMMARY_SMG[1,5],
    ...
    "\nC  ",paste0(sprintf("%.2f",round(FIND[,2],2)),collapse="     "),
    "\nUC ",paste0(sprintf("%.2f",round(FIND[,3],2)),collapse="     "))}else{
      cat(
        "\n\n\nObservations:",SUMMARY_PSS[[1]]$obs,
        "\nNumber of Lagged Regressors (not including LDV) (k): ",SUMMARY_PSS[[1]]$k,
        "\nCase: ",SUMMARY_PSS[[1]]$case,
        ...
        paste0(paste(FIND[,1]*100,"%"),collapse="     "),
        "\nC  ",paste0(sprintf("%.2f",round(FIND[,2],2)),collapse="     "),
        "\nUC ",paste0(sprintf("%.2f",round(FIND[,3],2)),collapse="     "))
    }
}
#' @examples
